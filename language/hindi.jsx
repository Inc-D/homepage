...
export const BODY = (FAQLink) => (
  <div>
    <h1>ओपन मल्टीप्लेयर</h1>
    <p>
      <em>Grand Theft Auto: San Andreas</em> के लिए एक आगामी मल्टीप्लेयर मॉड जो मौजूदा <em>San Andreas Multiplayer.</em> के साथ कंपैटिबल होगा।
    </p>
    <br />
    <p>
      इसका यह मतलब है की <strong>मौजूदा SA:MP client और सारे मौजूदा SA:MP स्क्रिप्ट्स एक दम सही चलेंगे open.mp के साथ</strong> और, इसके साथ काफी बग्स भी फिक्स होंगे। 
    </p>
    <p>
      अगर तुम यह सोच रहे हो की यह कब रिलीज होगा या तुम कैसे कंट्रीब्यूट कर सकते हो,तो तुमसे से रिक्वेस्ट है की तुम <a href="https://www.burgershot.gg/showthread.php?tid=99">इधर</a> जा कर देखो अऊर डिटेल्स के लिए। 
    </p>
    <h1>
      <FAQLink>FAQ</FAQLink>
    </h1>
...
export const FAQ = () => (
  <div>
    <h1>FAQ</h1>
    <hr />
    <h2>open.mp क्या है?</h2>
    <p>
      open.mp (Open Multiplayer, OMP) एक स्थानापन्न  मल्टीप्लयेर मॉड है San Andreas के लिए,
